                    ...
                    success: function(alerts) {
                        ...
                        for (var i = 0; i < alerts.length; i++) {
                            ...
                            if (sameDay(date1, date2) {
                                ...
                                }; dictJsonToSessions[String(sessionId)] = jsonOfSession; console.log("#### Session Json " + jsonOfSession);

                                var userQuery = new Parse.Query(Parse.User); userQuery.containedIn("objectId", dictUsersToSessions[String(sessionId)]);
